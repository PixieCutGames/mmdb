...
type TooltipProps = MMDBProps<{
  title: string;
  body: string;
  width: string;
}>;
export default function Tooltip({ title, body, width }: TooltipProps) {
  return (
    <div
      style={{ width: width ? width : "auto" }}
      className="mx-auto container max-w-[228px] top-0 left-1 translate-y-n-full px-3 py-2 -mt-1 bg-main rounded absolute text-white border border-main-light"
    >
