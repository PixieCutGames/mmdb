...
type FilterTableProps = MMDBProps<{
  inline?: boolean;
}>;
function FilterTable({ inline }: FilterTableProps) {
    ...
    <div className="bg-main-dark">
      <header className={`p-4 bg-main ${inline ? "hidden" : ""}`}>
        <h2 className="text-white">
          Filter Search Results <em>(coming soon)</em>
        </h2>
      </header>
            ...
            <Form>
              <div className="pb-4">
                ...
                <div className="flex flex-col xl:flex-row justify-between items-center">
                  <Field
                    className="text-white h-9 px-2 bg-main placeholder-main-light border border-main-light rounded w-full xl:w-auto"
                    name="startYear"
                    placeholder="ex. 1990"
                  />
              ...
              <div className="pb-4">
                ...
                <div className="relative">
                  ...
                  <Field
                    className="w-full text-white h-9 px-2 bg-main placeholder-main-light border border-main-light rounded appearance-none"
                    name="language"
                    as="select"
                  >
                  ...
                  {genres.map((genre) => (
                    <div className="w-1/2 mb-1" key={genre.id}>
                      <Field
                        ...
                        className="mr-2 appearance-none form-checkbox border border-main-light checked:border-main-light hover:checked:border-main-light rounded-md bg-main-dark  cursor-pointer text-main-dark"
                      />
              ...
              <div className="flex justify-end">
                <button
                  disabled
                  type="submit"
                  className="bg-success text-white hover:bg-success-dark py-2 px-3 rounded w-full xl:w-auto disabled:cursor-not-allowed disabled:opacity-20"
                >
                  Search
                </button>
              </div>
